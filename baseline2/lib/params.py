...
class DataArguments:
    ...
    def get_sentence_columns(self, task_name: Optional[str] = None):
        """Get sentence column names and features for multi-task."""
        if task_name is None:
            task_name = self.task_name

        # Format: (task_name, sentence1, feature_columns, sentence2)
        if task_name == 'QC':
            return 'QC', 'origin_query', ['category_path'], ''
        elif task_name == 'QI':
            return 'QI', 'origin_query', ['item_title'], ''
        elif task_name == 'QC_en':
            return 'QC_en', 'translated_query', ['category_path'], ''
        elif task_name == 'QI_en':
            return 'QI_en', 'translated_query', ['item_title'], ''
        elif task_name == 'QC_2lang':
            return 'QC_2lang', 'origin_query,translated_query', ['category_path'], ''
        elif task_name == 'QI_2lang':
            return 'QI_2lang', 'origin_query,translated_query', ['item_title'], ''
        else:
